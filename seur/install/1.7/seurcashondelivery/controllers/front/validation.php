...
class SeurCashOnDeliveryValidationModuleFrontController extends ModuleFrontController
{
    ...
    public function initContent()
    {
        ...
        if (!Tools::getValue('confirm')) {
            ...
            $cart_Amount = number_format($this->module->calculateCartAmount($cart, false), 2, '.', '');
            ...
            $this->setTemplate('module:seurcashondelivery/views/templates/front/validation.tpl');
        }
    }
	...
	public function postProcess()
	{
		...
		if (Tools::getValue('confirm'))
		{
			...
			SeurLib::setSeurOrder((int)$order->id, '',1, $order->getTotalWeight(), null, null, $this->module->calculateCartAmount($this->context->cart),0,(float)$order->total_paid);
...
//            $this->setTemplate('module:planb/views/templates/front/payment_error.tpl');
        }
	}
