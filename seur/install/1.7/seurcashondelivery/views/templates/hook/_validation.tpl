...
<h3>{l s='Cash on delivery by SEUR' mod='seurcashondelivery'}</h3>
    ...
    {if $nbProducts <= 0}
        <p class="warning">{l s='Your shopping cart is empty.' mod='planb'}</p>
    {else}
        ...
        <p class="cart_navigation">
                <a href="{$urls.base_url|escape:'htmlall':'UTF-8'}order.php?step=3" class="button_large">{l s='Other payment methods.' mod='seurcashondelivery'}</a>
