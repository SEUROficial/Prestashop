...
<table style="width: 330px;">
        ...
        <tr>
            ...
            {if $reembolso_show_detailed_taxes}
                ...
                <td style="background-color: #dddddd;">{$reembolso_cargo_tax}</td>
                <td style="background-color: #dddddd;">{$reembolso_cargo_tax_excl}</td>
            {/if}
            <td style="background-color: #dddddd;">{$reembolso_cargo}<sup>*</sup></td>
        </tr>
        <br />
        <tr>
