...
function upgrade_module_2_3_9($module) {
    ...
    $sql[] = "ALTER TABLE `"._DB_PREFIX_."seur2_order_pos` 
             CHANGE COLUMN `id_seur_pos` `id_seur_pos` VARCHAR(50) NOT NULL,
             CHANGE COLUMN `timetable` `timetable` VARCHAR(500) NOT NULL;";

    $sql[] = "ALTER TABLE `"._DB_PREFIX_."seur2_status` 
             DROP COLUMN `cod_tipo_situ`,
             DROP INDEX `cod_situ` ,
             ADD INDEX `cod_situ` (`cod_situ` ASC),
             CHANGE COLUMN `cod_situ` `cod_situ` VARCHAR(10) NOT NULL;";

    $sql[] = "DELETE FROM `"._DB_PREFIX_."seur2_status`;";
